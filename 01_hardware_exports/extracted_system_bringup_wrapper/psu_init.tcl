...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0x000FFFFF 0x00000020
		...
		#(OFFSET, MASK, VALUE)      (0XFF180138, 0x03FFFFFFU ,0x00004000U)  */
    mask_write 0XFF180138 0x03FFFFFF 0x00004000
    ...
    mask_write 0XFF180148 0x03FFFFFF 0x03FFFFFF
		...
		#(OFFSET, MASK, VALUE)      (0XFF18014C, 0x03FFFFFFU ,0x03FFBFFFU)  */
    mask_write 0XFF18014C 0x03FFFFFF 0x03FFBFFF
